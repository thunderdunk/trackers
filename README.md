...
*	Full Classes: Indicate a full or partially full class by adding `class="full"` to the `li` element, to a `span` around the affected part of the class title, or both. 
